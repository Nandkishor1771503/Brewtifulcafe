...
function Hero() {
  return (
    <>
      <div className="mobiledesign md:hidden p-8 bg-[#cc9f78] text-[#063d52]">
        ...
        <div className="flex items-center justify-center gap-10 my-5">
          ...
          <img
            src={espresso}
            alt=""
            className=" w-[60%] md:p-14 p-5 mr-5 md:mr-0 rounded-4xl shadow-2xl"
          />
        </div>
      </div>
      ...
      <div className="relative hidden md:flex md:flex-row flex-col gap-[38%] p-5 pl-14 w-full h-[75vh] bg-[#cc9f78] text-[#063d52]">
        <img
          src={latte}
          alt=""
          className=" w-[30%] p-14 rounded-4xl shadow-2xl"
        />
        <div className="absolute top-44 right-[37.5%]">
